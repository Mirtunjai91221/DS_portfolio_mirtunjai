...
/* ==========================================================================
   0. Dynamic Years of Experience Ingestion
   ========================================================================== */
function initExperience() {
    // Reference start date: November 15, 2019 (gives exactly 6.5 years as of May 15, 2026)
    const startDate = new Date(2019, 10, 15);
    const today = new Date();
    const diffMs = today - startDate;
    const diffYears = diffMs / (1000 * 60 * 60 * 24 * 365.25);
    const experienceValue = parseFloat(diffYears.toFixed(1));

    // Update all elements with class 'dyn-exp'
    document.querySelectorAll('.dyn-exp').forEach(el => {
        el.textContent = experienceValue;
    });

    // Update dashboard KPI attribute
    const kpiExp = document.getElementById('kpi-experience');
    if (kpiExp) {
        kpiExp.dataset.value = experienceValue;
        kpiExp.textContent = experienceValue;
    }
}
...
function initTerminalConsole() {
    ...
    function printMilestones() {
        ...
        appendLog(`2024 - Present: Senior IT Analyst @ Think Power Solutions LLC, Texas, USA (Remote)`, 'sys-info-line');
...
/* ==========================================================================
   8. Projects category dynamic filtering logic
   ========================================================================== */
        ...
        btn.addEventListener('click', () => {
            ...
            projectCards.forEach(card => {
                if (selectedFilter === 'all') {
                    ...
                    // Check if card has the class or category attribute containing the selected filter
